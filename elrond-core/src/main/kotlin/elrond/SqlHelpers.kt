...
suspend fun <T, E : Enum<E>> SearchQueryExecutor<E>.searchPrints(
    ...
    sortColumns: List<elrond.ElrondSortColumn>,
...
private fun List<elrond.ElrondSortColumn>.apply(builder: WhereQueryBuilder<*>, index: Int = 0, values: List<Any?>, distinctBySortColumn: elrond.ElrondSortColumn, inverse: Boolean = false) {
