...
private val collectionAltered = StaticColumnProperty(UserCard::isAltered, descriptor = SimplePropertyDescriptor(Strings.Query.Mtg.Comparison.IsAltered.KEY, propertyKeys.PRINT), key = "is_altered")
private val collectionProxy = StaticColumnProperty(UserCard::isProxy, descriptor = SimplePropertyDescriptor(Strings.Query.Mtg.Comparison.IsProxy.KEY, propertyKeys.PRINT), key = "is_proxy")
private val collectionSigned = StaticColumnProperty(UserCard::isSigned, descriptor = SimplePropertyDescriptor(Strings.Query.Mtg.Comparison.IsSigned.KEY, propertyKeys.PRINT), key = "is_signed")
private val collectionNotAltered = StaticColumnProperty(UserCard::isAltered, inverted = true, descriptor = SimplePropertyDescriptor(Strings.Query.Mtg.Comparison.IsAltered.KEY, propertyKeys.PRINT, true), key = "is_altered")
private val collectionNotProxy = StaticColumnProperty(UserCard::isProxy, inverted = true, descriptor = SimplePropertyDescriptor(Strings.Query.Mtg.Comparison.IsProxy.KEY, propertyKeys.PRINT, true), key = "is_proxy")
private val collectionNotSigned = StaticColumnProperty(UserCard::isSigned, inverted = true, descriptor = SimplePropertyDescriptor(Strings.Query.Mtg.Comparison.IsSigned.KEY, propertyKeys.PRINT, true), key = "is_signed")
